...
# blocking.  The streaming-standby (hot_standby) path, where the
# pgUpgradeReplayInProgress guard does the blocking, is covered separately by
# run_standby_connblock_test.
set -u
